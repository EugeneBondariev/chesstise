...
export const B2_GAMES: B2Game[] = [
  ...
  },
  {
    ...
    label:    'Morphy vs Bottin, Paris blindfold 1858',
    concepts: ['b2-t-smothered', 'b2-t-royal-fork', 'b2-t-fork-knight'],
    note:     "Morphy plays Qg8+! forcing Rxg8, after which Nf7# completes the smothered mate — king on f8, surrounded by its own pieces with every flight square occupied. A 10-move blindfold game that distils the entire pattern. Seeing Nf7# at the start of the combination is the entire skill.",
    category: 'tactics-sub',
  },
  {
    id:       'torrerepetto-76',
    title:    'Windmill — Perpetual Discovery',
    label:    'Torre vs Lasker, Moscow 1925',
    concepts: ['b2-t-windmill', 'b2-t-xray', 'b2-t-desperado'],
    note:     "25.Bf6 Qxh5 26.Rxg7+ Kh8 27.Rxf7+ Kg8 28.Rg7+ Kh8 29.Rxb7+ — Torre's rook bounces between g7 and each piece in turn, stripping five pieces while the bishop on f6 acts as a permanent anchor. Against the reigning World Champion. Once the windmill starts, the opponent can only watch.",
    category: 'tactics-sub',
  },
  {
    id:       'tal-658',
    title:    'Interference — Line Cut',
    label:    'Tal vs Portisch, Bled 1965',
    concepts: ['b2-t-interference', 'b2-t-xray'],
    note:     "Rxe6+! — Tal's rook sacrifice lands on e6, physically severing the communication between Portisch's queen and bishop. One sacrifice, two pieces suddenly disconnected, king exposed. Interference is the rarest of the five basic tactical motifs, but when it appears it is always spectacular.",
    category: 'tactics-sub',
  },
  {
    id:       null,
  ...
  },
  {
    ...
    label:    'Tal vs Stein, USSR Championship 1961',
    concepts: ['b2-t-greek-gift', 'b2-t-mating-net', 'b2-t-fork-knight'],
    note:     "14.Bxh7+! Kh8 — Tal sacrifices the bishop on h7, follows with Be4 controlling diagonals, and launches a devastating kingside attack. The Greek Gift (Bxh7+, Ng5+, Qh5) is the most common sacrifice in classical chess. Tal made it into an art form.",
    category: 'tactics-sub',
  },
  {
    id:       null,
