...
export const BLUEPRINT_GAMES: BlueprintGame[] = [
  ...
  {
    id:       'karpov-941',
    title:    'Skewer — Force the King, Win the Rook',
    label:    'Kasparov vs Karpov, World Championship 1985',
    concepts: ['t-skewer', 't-queen-sac', 't-clearance'],
    note:     "Queen sacrifice clears the d-file, Re8+ forces the king to h7, then Be4+ is a textbook skewer — the bishop attacks the king through to the rook on d7. A skewer is just a reversed pin: the more valuable piece in front must move, losing the piece behind.",
    category: 'tactics-attack',
  },
  {
    id:       'capablanca-407',
    title:    'Overloading — One Piece, Two Duties',
    label:    'Capablanca vs Matisons, Karlsbad 1929',
    concepts: ['t-overload', 't-remove-def', 'f-bishop-pair'],
    note:     "The knight on c6 is overloaded: it must simultaneously guard against Bxc6 and defend the b4 bishop against Qxb7. When a single piece guards two threats, one sacrifice forces it to abandon the other. Overloading is the most common tactic that beginners miss.",
    category: 'tactics-attack',
  },
  {
    id:       'karpov-480',
    title:    'Trapping — The Silent Asphyxiation',
    label:    'Karpov vs Miles, Tilburg 1977',
    concepts: ['t-trap', 't-fork', 'f-outpost'],
    note:     "Karpov's knight manoeuvres to c7, forks and traps the a8 rook (Nxa8), then repositions to b6 and traps the bishop on c8. No sacrifice, no combination — just two pieces removed from the board because their escape squares were quietly cut off moves earlier.",
    category: 'tactics-attack',
  },
  ...
  },
  {
    ...
    concepts: ['t-perpetual', 'e-queen', 'e-rook'],
    note:     "Down material, Smyslov forces perpetual check: Qc1+, Qd2+, Qxb2+ — the king cannot escape the same three squares. Knowing when to bail out into perpetual and how to construct the checking sequence is the single most important defensive skill in practical chess.",
    category: 'endgame',
  },
  {
    id:       null,
    title:    'Stalemate Trap & Fortress Draw',
    label:    'A game saved by stalemate or positional fortress (pending)',
    concepts: ['t-stalemate', 'e-fortress', 'e-bishop-opp'],
    note:     "The stalemate trick turns certain loss into draw: the inferior side sacrifices all remaining pawns or steps into a position where the opponent cannot move without causing stalemate. The fortress is its positional cousin — a defensive setup that simply cannot be broken despite material deficit.",
    category: 'endgame',
  },
  {
    id:       null,
    title:    'Philidor Position & Bishop Endings',
    label:    'Rook defense (Philidor) and same/opposite-colour bishop technique (pending)',
    concepts: ['e-philidor-end', 'e-bishop-same', 'e-bishop-opp'],
    note:     "The Philidor position — rook on the sixth rank, sliding to the back rank only when the pawn advances — is the most important defensive idea in rook endgames. Same-colour bishop endings convert by zugzwang; opposite-colour bishop endings draw by fortress. Every serious player must know all three.",
    category: 'endgame',
  },
];
