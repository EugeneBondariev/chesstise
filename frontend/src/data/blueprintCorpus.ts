...
export const BLUEPRINT_GAMES: BlueprintGame[] = [
  ...
  {
    id:       'capablanca-115',
    title:    'Stalemate & Fortress — The Iron Wall',
    label:    'Capablanca vs Lasker, St Petersburg 1914',
    concepts: ['t-stalemate', 'e-fortress', 'e-bishop-opp'],
    note:     "Lasker constructs a textbook fortress against the future World Champion: his king oscillates Kc8–Kd7 and the bishop toggles on the same two squares, making no progress possible despite Capablanca's extra passed pawn. One of the clearest demonstrations of the fortress draw — and of knowing when to stop trying to win.",
    category: 'endgame',
  },
  {
    id:       'smyslov-525',
    title:    'Bishop Endings — Technique & the Draw',
    label:    'Smyslov vs Botvinnik, World Championship 1954',
    concepts: ['e-bishop-same', 'e-philidor-end'],
    note:     "After the queens come off, the game resolves to a pure bishop endgame: Smyslov's a-pawn is stalled by the blockade, and neither side can make progress. The same-colour bishop ending with blocked pawns is a theoretical draw — Botvinnik simply keeps his bishop active and refuses to allow any pawn break.",
    category: 'endgame',
  },
];
